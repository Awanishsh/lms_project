                ...
                <div className="flex flex-col gap-5 p-2 shadow-[0_0_10px_black] w-96  rounded-lg">
                    ...
                    {userInput.videoSrc ?(
                        ...
                        <div className="h-48 border flex items-center justify-center cursor-pointer">
                            <label className="font-semibolt text-xl cursor-pointer" htmlFor="lecture">Choose your video</label>
                            <input type="file" className="hidden" id="lecture" onSubmit={handleVideo} accept="videp/mp4  video/x-map4 video/*"/>
                        </div>
