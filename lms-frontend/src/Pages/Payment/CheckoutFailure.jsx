 ...
 return(
    <HomeLayout>
        <div className=" min-h-[90vh] flex items-center justify-center text-white">
            ...
            <Link to="/Checkout" className="bg-red-500 hover:bg-red-600 transition-all ease-in-out duration-300 absolute bottom-0 w-full  px-2 text-xl font-semibold text-center rounded-br-lg rounded-bl-lg">
